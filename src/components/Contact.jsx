  ...
  return (
    ...
    <div class="container px-5 py-14 mx-auto">
      <div class="flex flex-col text-center w-full mb-12">
        <h1 class="sm:text-5xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Us</h1>
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Send us a Message so we can save your Passwords more securely with suggestions of yours</p>
      </div>
